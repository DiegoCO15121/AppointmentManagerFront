...
import SecurityModal from "@/components/admin/modals/SecurityModal";
...
export default function AdminHomeView() {
  ...
  const handleSearchBoss = () => {
    setIsOpen();
    openModal("search-boss");
  };

  const handleSecurityAccounts = () => {
    setIsOpen();
    openModal("security");
  }
  if (data)
          ...
          <div className="flex flex-col space-y-10">
            ...
            <div className="space-y-10 flex flex-col overflow-x-auto w-full">
              <div className="flex flex-col md:flex-row justify-between gap-4 items-center">
                <div className="flex flex-col space-y-3">
                  <h2 className="text-gray-600 font-bold text-3xl md:text-center xl:text-justify">
                    Administra Administradores de Área
                  </h2>
                  <p className="text-gray-600 text-xl md:text-center xl:text-justify">
              ...
              hover:text-white transition-colors hover:shadow-lg"
                  ...
                  <button
                    type="button"
                    onClick={handleSecurityAccounts}
                    className="bg-blue-50 border-2 border-blue-900 px-3 py-2 text-gray-500 text-sm uppercase 
              flex justify-center gap-3 hover:cursor-pointer font-bold items-center rounded-lg hover:bg-blue-900 
              hover:text-white transition-colors hover:shadow-lg"
                  >
                    <MdOutlineSecurity className="w-5 h-5" />
                    <p>Cuentas de seguridad</p>
                  </button>
                </div>
              </div>
